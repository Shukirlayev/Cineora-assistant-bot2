...
const handleHelp = async (ctx) => {
    ...
    const helpText = `📚 <b>CINEORA ASSISTANT V2 - TO'LIQ QO'LLANMA</b>\n\n` +
        ...
        `Menyudagi "🔀 Rejim" tugmasi orqali ishlash rejimini tanlang:\n` +
        ...
        `2. <i>🏁 Mavsumni Yopish</i> tugmasini bosing. (S01 arxivlanadi va S02 ga o'tiladi).\n` +
        `3. 2-fasl videolarini tashlang. Ular avtomat S02E01 dan sanalishni boshlaydi.\n` +
        ...
        `• <b>⚙️ Tizim Sozlamalari:</b> Faqat Asosiy Egaga (Owner) ko'rinadi. Bu yerdan yordamchi adminlarni qo'shishingiz mumkin. Ikkala admin bir vaqtda ishlasa ham xalaqit qilmaydi (Shaxsiy ish stoli).\n\n` +
    ...
    autoWipe(ctx, sent.message_id, 120000); // 2 daqiqa turadi
};
